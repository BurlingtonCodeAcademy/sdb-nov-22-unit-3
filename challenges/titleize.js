...
let phrase1 = "sChool is CoOL";
console.log("variable version", capitalize(phrase1));
...
function titleize(phrase) {
  ...
  console.log("arrayOfCapitalLetteredWords: ", arrayOfCapitalLetteredWords);
...
console.log("function refactored", titleizeRefactored("sChool is CoOL"));

const arrowFunctionRefactored = (phrase) =>
  phrase.split(" ").map(capitalize).join(" ");

console.log("arrow function", arrowFunctionRefactored("sChool is CoOL"));
